...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Search Console, now per page, fixes that. Premium users can connect a Search Console property to any of their pages and watch the numbers for their own name — the queries, the impressions, the position — instead of a site's aggregate.",
  ...
  },
  {
    ...
    body: [
      ...
      "From today, one-word slugs are protected while you're a Premium subscriber. The rule is simple, the enforcement is at the database level, and there is no workaround.",
      ...
      { h: "Protected while you subscribe" },
      "While your Premium subscription is active, your one-word slug is exclusively yours. Nobody can claim it, nobody can auction it, nobody can hold it hostage. It stays yours by design, enforced at the database level — not by a promise in a policy document.",
      { h: "What happens when a subscription lapses" },
      "The rules are deliberately simple:",
      {
        ul: [
          "Monthly plan: if your subscription lapses, the slug returns to the pool immediately — the exclusivity is the benefit, and the benefit ends with the subscription.",
          "Annual plan: you get a 30-day grace period before release, with reminders at days 7, 1, and 0 — enough time to renew without losing your name.",
          "During the grace period the slug is still yours: nobody else can claim it while it's pending release.",
        ],
      },
  ...
  },
  {
    ...
    full: true,
    body: [
      "namesranker.com/your-name is a great URL. yourname.com is a better one. It's the address you put on a business card, the domain in your email signature, the link a journalist types from memory. From today, every premium page can be served from a domain you own — with setup that takes minutes and no code.",
  ...
  },
  {
    ...
    full: true,
    body: [
      "Most SaaS pricing is a maze built to extract more, not serve better: three tiers, feature ladders, per-seat add-ons, and a sales call hiding somewhere in the middle. NamesRanker Premium is deliberately the opposite — one plan, three ways to pay, every feature in every tier.",
      "Here's the whole pricing policy, and the reasoning behind it.",
      { h: "One plan, three ways to pay" },
      "Premium costs $30 a month, $299 a year, or $1,399 once. The choice is about how you want to pay, not what you get — monthly for flexibility, annual for two months free, lifetime for the people who've decided this is a permanent asset.",
      "There is no Basic, Pro, and Enterprise ladder. There is no feature locked behind a higher tier. Search Console, custom domains, name monitoring, imports, sub-pages — everything premium is included in every plan.",
      { h: "The grace period that respects your name" },
      "A one-word name is protected while you subscribe — and that makes billing a security decision, not just a payment decision. So the end of a subscription has to be handled with care:",
      {
        ul: [
          "Monthly plan: if you cancel or lapse, the slug returns to the pool immediately — the exclusivity is the benefit you paid for, and it ends with the payment.",
          "Annual plan: you get a 30-day grace period before the slug is released — time to renew or export without losing your name.",
          "Reminders at days 7, 1, and 0: three clear emails, then it's fair game. No surprise releases.",
        ],
      },
      "The asymmetry is deliberate: monthly is short-term by design, so it releases fast; annual is a bigger commitment, so it gets a runway. Both are spelled out before you pay, not discovered in a support ticket.",
      ...
      "One plan removes the game entirely. The only reason to upgrade is because you want the whole product, and the only reason to leave is because you don't want it at all.",
      { h: "What happens if you cancel" },
      "You keep your page, your content, and your data — premium features stop, but nothing is deleted. Export your content anytime, take it anywhere, and if you come back, your slug (if still available) and your settings are waiting.",
      "Billing should be the least interesting part of owning your name. We built it to stay that way.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      { h: "Auto-sync for premium, manual for everyone else" },
      {
        ul: [
          "Premium pages sync automatically on a schedule — new posts, repos, and uploads appear without you touching anything.",
          "Free pages sync manually, one click at a time — the content is yours either way.",
